...
team = input("enter a names separated by coma and space:\n")
team_list = team.split(", ")
# print(team_list)
# random.seed(1)
# lucky_reach_guy = team_list[random.randint(0, len(team_list) -1)].capitalize()
lucky_reach_guy = random.choice(team_list).capitalize()
print(f"and the most lucky person today is: {lucky_reach_guy}!")
